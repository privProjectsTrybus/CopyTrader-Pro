...
const TITLES = { dashboard:'Dashboard', markets:'Live Markets', traders:'Top Traders', bots:'My Bots', copied:'Live Trade Feed', portfolio:'Portfolio', history:'Trade History', settings:'Bot Settings', apikeys:'API Keys' };
